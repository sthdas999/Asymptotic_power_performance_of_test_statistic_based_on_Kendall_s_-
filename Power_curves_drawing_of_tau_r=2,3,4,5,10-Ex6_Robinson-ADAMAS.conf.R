...
setwd('C:/Users/hp/Desktop/R-programs-for-gen-semipar/Paper_for_ADAMAS_CONF/Ex - 5,6')
G = read.csv(file = 'Simulated_powers_Tn_r=2,3,4,5,10-Ex6_Robinson-ADAMAS_c=(-1,3,-2,4,-5).conf.csv')
mu = G[,1]
