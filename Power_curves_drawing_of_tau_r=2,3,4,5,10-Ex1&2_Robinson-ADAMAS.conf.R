...
setwd('C:/Users/hp/Desktop/R-programs-for-gen-semipar/Paper_for_ADAMAS_CONF/Ex - 1, 2')
G = read.csv(file = 'Simulated_powers_Vn_r=2,3,4,5,10-Ex1_Robinson-ADAMAS_c=(-0.13, -2.1,  5.6, -0.95).conf.csv')
mu = G[,1]
...
G = read.csv(file = 'Simulated_powers_Vn_r=2,3,4,5,10-Ex2_Robinson-ADAMAS_c=(-0.13, -2.1,  5.6, -0.95).conf.csv')
mu = G[,1]
Power.Vn.order.2 = G[,2]
Power.Vn.order.3 = G[,3]
Power.Vn.order.4 = G[,4]
