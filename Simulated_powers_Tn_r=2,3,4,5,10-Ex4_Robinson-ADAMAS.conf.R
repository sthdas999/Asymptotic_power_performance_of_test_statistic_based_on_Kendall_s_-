...
r1 = c(0.18,-0.06,0.09,0.32,-0.18)
r2 = c(-0.06,0.14,-0.17,0.25,0.15)
r3 = c(0.09,-0.17,0.25,-0.3,-0.23)
r4 = c(0.32,0.25,-0.3,0.2,0.17)
r5 = c(-0.18,0.15,-0.23,0.17,0.25)
...
for(j in 1:N)
{
  ...
  num.g_x3.W1w2[j] = mean(weight.w1.w2(w1.star[j],w2.star[j])*x3.star)
}
...
g.hat_x3.W1w2 = num.g_x3.W1w2/density.w1w2

e.hat_x1.W1w2 = x1 - g.hat_x1.W1w2
e.hat_x2.W1w2 = x2 - g.hat_x2.W1w2
e.hat_x3.W1w2 = x3 - g.hat_x3.W1w2

e.hat_x.matrix <- matrix(nrow = N, ncol = 3)
for(column in 1:2){
  e.hat_x.matrix[, 1] <- e.hat_x1.W1w2
  e.hat_x.matrix[, 2] <- e.hat_x2.W1w2
  e.hat_x.matrix[, 3] <- e.hat_x3.W1w2
}
...
cbind(beta1.hat,beta2.hat,beta3.hat)

Y.star.dash = Y.star-beta1.hat*x1.star-beta2.hat*x2.star-beta3.hat*x3.star
...
Y.star.hat = beta1.hat*x1.star+beta2.hat*x2.star+beta3.hat*x3.star+m.hat.w1.w2
...
Y1 = beta1.hat*x1+beta2.hat*x2+beta3.hat*x3+m.w1.w2+eps1
...
Y1.star.dash = Y1.star-beta1.hat*x1.star-beta2.hat*x2.star-beta3.hat*x3.star
...
Y1.star.hat = beta1.hat*x1.star+beta2.hat*x2.star+beta3.hat*x3.star+m.hat1.w1.w2
...
setwd('C:/Users/hp/Desktop/R-programs-for-gen-semipar/Paper_for_ADAMAS_CONF/Ex - 3,4')
write.csv(Power.Vn.table, file = 'Simulated_powers_Vn_r=2-Ex4_Robinson.csv')
